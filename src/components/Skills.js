  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="MongoDB & MySql" x="-20vw" y="-15vw" />
        <Skill name="Daisy & Material UI" x="15vw" y="-12vw" />
        <Skill name="Github" x="-35vw" y="-5vw" />
        <Skill name="Wordpress" x="32vw" y="-5vw" />
        <Skill name="Figma" x="0vw" y="-20vw" />
        <Skill name="Firebase" x="-25vw" y="18vw" />
        <Skill name="Tailwind & Bootstrap" x="28vw" y="18vw" />

        {/* Added Skills */}
        <Skill name="NextJS" x="38vw" y="8vw" />
        <Skill name="Python" x="-38vw" y="10vw" />
        <Skill name="C" x="10vw" y="24vw" />
        <Skill name="C++" x="-10vw" y="24vw" />
        <Skill name="Machine Learning" x="22vw" y="-22vw" />
        <Skill name="Deep Learning" x="-28vw" y="-25vw" />
      </div></>
  );
};
