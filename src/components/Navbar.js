  ...
  return (
    ...
    ">
      ...
      >
          ...
          target={"_blank"}
          className="w-6 mr-5"
          href="https://www.facebook.com/Jamy4244"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mr-5"
          href="https://twitter.com/MDSadatKhan2"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mr-5"
          href="https://www.linkedin.com/in/sadatcse/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout my Linkdin profile"
        >
          <GrLinkedin size={30} />
        </motion.a>
        <motion.a
          target={"_blank"}
          className="w-6 mr-5"
          href="https://www.github.com/sadatcse/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        >
          {mode === "light" ? (
            <FaSun size={35} className={""} />

          ) : (
            <IoMdMoon size={35} className={"fill-dark"}  />
