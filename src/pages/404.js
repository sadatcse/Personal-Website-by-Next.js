...
const NotFound = () => {
  return (
    <>
      <Head>
        <title>Sadat khan | 404 Page </title>
        <meta
          name="description"
          content="Embark on a journey through sadatkhan.com – a Next.js developer portfolio unveiling the latest in web application projects and insightful software engineering articles. Showcasing expertise as a full-stack developer and software engineer."
        />
      </Head>
      <TransitionEffect />
