Next.js Portfolio Project (For Personal Use)

Copyright (c) 2023 Sadat Khan

This software and its accompanying documentation files ("the Software") are provided for personal use only, subject to the following conditions:
...
3. Attribution to the original author is required when using the Software for commercial purposes. Please provide attribution by adding a link to https://sadatkhan.com and stating that the software was created or designed by Sadat Khan.
...
For inquiries regarding commercial use, please contact us at sadatcse@gmail.com.
